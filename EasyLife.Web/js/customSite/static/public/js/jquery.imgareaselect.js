...
function div() {
    return $("<div class='cut-laywer'></div>");
}
...
$.imgAreaSelect = function (img, options) {
    ...
    function update(resetKeyPress) {
        ...
        if ($.support.msie && $border.outerWidth() - $border.innerWidth() == 2) {
            $border.css('margin', 0);
    ...
    $.imgAreaSelect.keyPress = $.support.msie ||
        $.support.safari ? 'keydown' : 'keypress';
    ...
    $box.add($outer).css({ visibility: 'hidden', position: position,
        overflow: 'hidden', zIndex: zIndex || '0', display:'none'});
